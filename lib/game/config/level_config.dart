...
class LevelConfig {
  ...
  static LevelData _getLevel5() {
    return const LevelData(
      ...
      obstacles: [
        ...
        ObstacleData(
          type: ObstacleType.rotating,
          position: Offset(250, 260),
          size: Size(100, 20),
        ),
        ObstacleData(
          type: ObstacleType.magnet,
          position: Offset(150, 340),
          size: Size(100, 20),
        ),
        ObstacleData(
          type: ObstacleType.lava,
          position: Offset(250, 420),
          size: Size(80, 20),
        ),
        ObstacleData(
          type: ObstacleType.trampoline,
          position: Offset(100, 420),
          size: Size(80, 20),
        ),
      ],
      goal: Offset(100, 520),
  ...
  static LevelData _getLevel8() {
    return const LevelData(
      ...
      obstacles: [
        ...
        ObstacleData(
          type: ObstacleType.ice,
          position: Offset(150, 380),
          size: Size(100, 20),
        ),
        ObstacleData(
          type: ObstacleType.lava,
          position: Offset(250, 430),
          size: Size(60, 20),
        ),
      ],
      goal: Offset(100, 520),
  ...
  static LevelData _generateRandomLevel(int levelId) {
    ...
    return LevelData(
      ...
      obstacles: obstacles,
      goal: Offset(
          50 + (300 * ((levelId + 1) % 4)) / 3, 500 + (levelId % 3) * 15),
