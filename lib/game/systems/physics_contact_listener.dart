...
class PhysicsContactListener extends ContactListener {
  ...
  void _handleObstacleCollision(Ball ball, BaseObstacle obstacle, Contact contact) {
    ...
    switch (obstacle.runtimeType) {
      ...
      case TrampolineObstacle:
        _handleTrampolineCollision(ball, obstacle as TrampolineObstacle, contact);
        break;
  ...
  void _handleTrampolineCollision(Ball ball, TrampolineObstacle trampoline, Contact contact) {
